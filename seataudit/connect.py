"""Native cognis-connect emit for seataudit — forward findings to any platform.

Maps seataudit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    seataudit ... --format json | seataudit-emit --to stix
    seataudit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
