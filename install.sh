#!/usr/bin/env sh
# Universal installer for seataudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/seataudit.git"
echo "Installing seataudit ..."
