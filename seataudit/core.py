"""SEATAUDIT core — SaaS license, seat-usage and shadow-IT auditor."""
...
RULES = [
    ("SEA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SEA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SEA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
